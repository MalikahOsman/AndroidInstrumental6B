...
public class CustomerRepositoryImpl extends SQLiteOpenHelper implements CustomerRepository {
    ...
    public static final String COLUMN_CUSTOMER_NUM = "custNum";
    ...
    private static final String DATABASE_CREATE = " CREATE TABLE "
            ...
            + COLUMN_CUSTOMER_NUM + "TEXT NOT NULL );";
    ...
    public Customer findById(Long id) {
        ...
        if(cursor.moveToFirst()){
            final Customer Customer = new Customer.Builder()
                    ...
                    .custNum(cursor.getString(cursor.getColumnIndex(COLUMN_CUSTOMER_NUM)))
                    .build();
            return Customer;
        }else{
            return null;
    ...
    public Customer save(Customer entity) {
        ...
        values.put(COLUMN_CUSTOMER_NUM, entity.getCustNum());
