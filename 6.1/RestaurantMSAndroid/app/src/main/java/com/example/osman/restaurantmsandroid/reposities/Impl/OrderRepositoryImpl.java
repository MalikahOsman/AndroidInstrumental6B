...
import com.example.osman.restaurantmsandroid.reposities.OrderRepository;
...
public class OrderRepositoryImpl extends SQLiteOpenHelper implements OrderRepository {
    ...
    public Order findById(Long id) {
        ...
        if(cursor.moveToFirst()){
            final Order Order = new Order.Builder()
                    ...
                    .orderNum(cursor.getInt(cursor.getColumnIndex(COLUMN_ORDER_NUM)))
    ...
    public Order save(Order entity) {
        ...
        values.put(COLUMN_ORDER_NUM, entity.getOrderNum());
    ...
    public Order update(Order entity) {
        ...
        ContentValues values = new ContentValues();
        values.put(COLUMN_ID, entity.getId());
        values.put(COLUMN_ORDER_NUM, entity.getOrderDate());
        values.put(COLUMN_ORDER_DATE, entity.getOrderDate());
        db.update(
                TABLE_NAME,
                values,
    ...
    public Set<Order> findAll() {
        ...
        if (cursor.moveToFirst()){
            do{
                final Order setting = new Order.Builder()
                        .id(cursor.getLong(cursor.getColumnIndex(COLUMN_ID)))
                        .orderNum(cursor.getInt(cursor.getColumnIndex(COLUMN_ORDER_NUM)))
                        .orderDate(cursor.getString(cursor.getColumnIndex(COLUMN_ORDER_DATE)))
                        .build();
